...
import { Cookies } from 'react-cookie'; // react-cookie 패키지 import
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Typography 
            ...
            component="a"
            href="/"
            onClick={handleHomeLinkClick} // 홈 링크 클릭 시 handleHomeLinkClick 함수 호출
            sx={{
              mr: 2,
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={setting === '로그아웃' ? handleLogoutClick : handleCloseUserMenu}>
